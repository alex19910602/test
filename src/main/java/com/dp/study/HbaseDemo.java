...
public class HbaseDemo {
    ...
    public static List<User> getAllData(String tableName) {
        ...
        public static void createTable(String tableN, String[] cols) throws IOException {
     ...
     * @param tableN
     */
    public static void getNoDealData(String tableN) throws IOException {
        try {
            Table table = initHbase().getTable(TableName.valueOf(tableN));
            Scan scan = new Scan();
    ...
    public static void insertData(String tableName, User user) throws IOException {
         ...
         * @throws IOException
         */
    public static void deleteByRowKey(String tableN, String rowKey) throws IOException {
        Table table = initHbase().getTable(TableName.valueOf(tableN));
     ...
     * @throws IOException
     */
    public static void deleteTable(String tableN) throws IOException {
        TableName tableName = TableName.valueOf(tableN);
        admin = initHbase().getAdmin();
